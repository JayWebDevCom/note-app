(function(exports) {
  function NoteController(
    noteList,
    NoteListViewConstructor = NoteListView,
  ...
  NoteController.prototype.findNoteAndUpdatePageWithHTMLEDcontent = function(
    noteId
  ) {
    var noteToReturn = this._noteList.getNote(noteId);
    this._noteElement.innerHTML = new this._singleNoteViewConstructor(
      noteToReturn
    ).returnHTML();
  };
